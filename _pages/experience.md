...
- Developed end-to-end business operations from sourcing to customer delivery

---

## Research Interests

My research interests focus on the intersection of quantitative finance, market microstructure, and computational methods:

- **Market Microstructure:** Order book dynamics, price formation, liquidity provision
- **Systematic Trading:** Algorithmic trading strategies, backtesting methodologies, execution optimization
- **Derivatives Pricing:** Option pricing models, Monte Carlo methods, variance reduction techniques
- **Machine Learning in Finance:** Time series forecasting, feature engineering, deep learning applications
- **DeFi & Crypto Markets:** Decentralized finance protocols, cross-venue arbitrage, on-chain analytics

---

## Professional Goal

I am seeking opportunities as a **Quantitative Researcher** or **Quantitative Trading Analyst** in a cryptocurrency hedge fund, proprietary trading firm, or systematic trading desk with exposure to DeFi and digital asset markets.
